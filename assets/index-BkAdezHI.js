const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/routes-CxqBet-k.js","assets/dist-DubO62zS.js","assets/jsx-runtime-BmgZPGeN.js","assets/chunk-SmwYcJT_.js","assets/react-Dp0uNt7U.js","assets/routes-2fEd4Iv-.css","assets/work-oj_KHZA9.js","assets/projectRegistry-C9x_LS4C.js","assets/projectRegistry-BxWIbDUQ.css","assets/createLucideIcon-CWqp94-Z.js","assets/work-DKcwpRPT.css"])))=>i.map(i=>d[i]);
import { n as __toESM, t as __commonJSMin } from "./chunk-SmwYcJT_.js";
import { t as require_react } from "./react-Dp0uNt7U.js";
import { A as DEFAULT_PROTOCOL_ALLOWLIST, B as last, C as findFlatMatch, D as processRouteTree, E as processRouteMasks, F as escapeHtml, G as usePrevious, H as replaceEqualDeep, I as functionalUpdate, L as isDangerousProtocol, M as decodePath, N as deepEqual, O as invariant, P as encodePathLikeUrl, S as trimPathRight, T as findSingleMatch, V as nullReplaceEqualDeep, W as useLayoutEffect, _ as interpolatePath, a as __vitePreload, b as trimPath, c as require_react_dom, d as tiny_warning_esm_default, f as routerContext, g as compileDecodeCharMap, h as cleanPath, j as createControlledPromise, k as createLRUCache, l as useRouterState, m as useHydrated, o as require_compiler_runtime, p as ClientOnly, s as Link, u as useRouter, v as joinPaths, w as findRouteMatch, y as resolvePath, z as isPromise } from "./dist-DubO62zS.js";
import { a as createRootRoute, c as isNotFound, i as createLazyFileRoute, n as lazyRouteComponent, o as isRedirect, r as createFileRoute, s as redirect, t as Route$3 } from "./_id-f8_6zwSa.js";
import { t as require_jsx_runtime } from "./jsx-runtime-BmgZPGeN.js";
import { y as matchContext } from "./projectRegistry-C9x_LS4C.js";
(function polyfill() {
...
function createScrollRestorationCache() {
	...
	const persistedState = safeSessionStorage.getItem("tsr-scroll-restoration-v1_3");
	...
	return {
		...
		set: (updater) => {
			...
			try {
				safeSessionStorage.setItem("tsr-scroll-restoration-v1_3", JSON.stringify(state));
			} catch {
...
function restoreScroll({ storageKey: storageKey$1, key, behavior, shouldScrollRestoration, scrollToTopSelectors, location }) {
	let byKey;
	try {
		byKey = JSON.parse(sessionStorage.getItem(storageKey$1) || "{}");
	} catch (error) {
		console.error(error);
		return;
	}
...
function setupScrollRestoration(router$1, force) {
	...
	if (router$1.isScrollRestorationSetup || !scrollRestorationCache) return;
...
function createAtom(valueOrFn, options$1) {
	...
	const atom = {
		...
		_update(getValue) {
			...
			const compare$1 = options$1?.compare ?? Object.is;
			if (isComputed) {
				activeSub = atom;
				++cycle;
				atom.depsTail = void 0;
			...
			try {
				...
				if (oldValue === void 0 || !compare$1(oldValue, newValue)) {
...
function effect(fn) {
	...
	const effectObj = {
		...
		notify() {
			...
			if (flags & ReactiveFlags.Dirty || flags & ReactiveFlags.Pending && checkDirty(this.deps, this)) run$1();
...
var syncMatchContext = (inner, matchId, index$1) => {
	const nextContext = buildMatchContext(inner, index$1);
...
var executeBeforeLoad = (inner, matchId, index$1, route) => {
	...
	const updateContext = (beforeLoadContext$1) => {
		...
		if (isRedirect(beforeLoadContext$1) || isNotFound(beforeLoadContext$1)) {
			pending();
			handleSerialError(inner, index$1, beforeLoadContext$1, "BEFORE_LOAD");
		}
		batch$1(() => {
			pending();
			inner.updateMatch(matchId, (prev) => ({
...
var getLoaderContext = (inner, matchPromises, matchId, index$1, route) => {
	const parentMatchPromise = matchPromises[index$1 - 1];
...
var runLoader = async (inner, matchPromises, matchId, index$1, route) => {
	try {
		const match = inner.router.getMatch(matchId);
		try {
			...
			const loaderResult = loader?.(getLoaderContext(inner, matchPromises, matchId, index$1, route));
...
var loadRouteMatch = async (inner, matchPromises, index$1) => {
	async function handleLoader(preload$1, prevMatch, previousRouteMatchId, match$1, route$1) {
		const age = Date.now() - prevMatch.updatedAt;
		const staleAge = preload$1 ? route$1.options.preloadStaleTime ?? inner.router.options.defaultPreloadStaleTime ?? 3e4 : route$1.options.staleTime ?? inner.router.options.defaultStaleTime ?? 0;
		const shouldReloadOption = route$1.options.shouldReload;
		const shouldReload = typeof shouldReloadOption === "function" ? shouldReloadOption(getLoaderContext(inner, matchPromises, matchId, index$1, route$1)) : shouldReloadOption;
		...
		if (preload$1 && route$1.options.preload === false) {} else if (loaderShouldRunAsync && !inner.sync && shouldReloadInBackground) {
			loaderIsRunningAsync = true;
			(async () => {
				try {
					await runLoader(inner, matchPromises, matchId, index$1, route$1);
		...
		} else if (status !== "success" || loaderShouldRunAsync) await runLoader(inner, matchPromises, matchId, index$1, route$1);
		else syncMatchContext(inner, matchId, index$1);
	}
	const { id: matchId, routeId } = inner.matches[index$1];
	...
	if (shouldSkipLoader(inner, matchId)) {
		if (!inner.router.getMatch(matchId)) return inner.matches[index$1];
		syncMatchContext(inner, matchId, index$1);
	} else {
		const prevMatch = inner.router.getMatch(matchId);
		const previousRouteMatchId = inner.router.state.matches[index$1]?.routeId === routeId ? inner.router.state.matches[index$1].id : inner.router.state.matches.find((d) => d.routeId === routeId)?.id;
		const preload$1 = resolvePreload(inner, matchId);
		if (prevMatch._nonReactive.loaderPromise) {
			...
			if (match$1.status === "pending") await handleLoader(preload$1, prevMatch, previousRouteMatchId, match$1, route);
		} else {
			...
			await handleLoader(preload$1, prevMatch, previousRouteMatchId, match$1, route);
		}
	}
	const match = inner.router.getMatch(matchId);
...
async function loadMatches(arg) {
	const inner = arg;
	const matchPromises = [];
	if (inner.router.state.matches.some((d) => d._forcePending)) triggerOnReady(inner);
...
function createBrowserHistory(opts) {
	...
	const queueHistoryAction = (type, destHref, state) => {
		...
		if (!scheduled) scheduled = Promise.resolve().then(() => flush$2());
	};
...
var RouterCore = class {
	constructor(options$1) {
			...
			loadPromise = new Promise((resolve) => {
				this.startTransition(async () => {
					try {
						...
						this.__store.setState((s) => ({
							...s,
							statusCode: redirect$1 ? redirect$1.status : notFound ? 404 : s.matches.some((d) => d.status === "error") ? 500 : 200,
							redirect: redirect$1
						}));
					}
		...
		this.update({
			...
			protocolAllowlist: options$1.protocolAllowlist ?? DEFAULT_PROTOCOL_ALLOWLIST
		});
	...
	matchRoutesInternal(next, opts) {
		...
		for (let index$1 = 0; index$1 < matchedRoutes.length; index$1++) {
			const route = matchedRoutes[index$1];
		...
		for (let index$1 = 0; index$1 < matches.length; index$1++) {
...
function buildMiddlewareChain(destRoutes) {
	...
	const applyNext = (index$1, currentSearch, middlewares) => {
		if (index$1 >= middlewares.length) return currentSearch;
		const middleware = middlewares[index$1];
		const next = (newSearch) => {
			return applyNext(index$1 + 1, newSearch, middlewares);
		};
		return middleware({
...
function ScrollRestoration() {
	...
	if (!router$1.isScrollRestoring || true) return null;
	if (typeof router$1.options.scrollRestoration === "function") {
...
var Match = import_react.memo(function MatchImpl({ matchId }) {
	...
	}), matchState.parentRouteId === "__root__" && router$1.options.scrollRestoration ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(OnRendered, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollRestoration, {})] }) : null] });
});
function OnRendered() {
	const router$1 = useRouter();
...
var MatchInner = import_react.memo(function MatchInnerImpl({ matchId }) {
	...
	const { match, key, routeId } = useRouterState({
		select: (s) => {
			const match$1 = s.matches.find((d) => d.id === matchId);
			const routeId$1 = match$1.routeId;
			const remountDeps = (router$1.routesById[routeId$1].options.remountDeps ?? router$1.options.defaultRemountDeps)?.({
				routeId: routeId$1,
...
function Matches() {
	...
	const pendingElement = PendingComponent ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PendingComponent, {}) : null;
	const inner = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(typeof document !== "undefined" && router$1.ssr ? SafeFragment : import_react.Suspense, {
		fallback: pendingElement,
...
var useTags = () => {
	const router$1 = useRouter();
	const nonce = router$1.options.ssr?.nonce;
	...
	const links = useRouterState({
		select: (state) => {
			const constructed = state.matches.map((match) => match.links).filter(Boolean).flat(1).map((link$2) => ({
				tag: "link",
				attrs: {
					...link$2,
					nonce
			...
			const manifest = router$1.ssr?.manifest;
	...
	const preloadLinks = useRouterState({
		select: (state) => {
			const preloadLinks$1 = [];
			state.matches.map((match) => router$1.looseRoutesById[match.routeId]).forEach((route) => router$1.ssr?.manifest?.routes[route.id]?.preloads?.filter(Boolean).forEach((preload$1) => {
				preloadLinks$1.push({
					tag: "link",
					attrs: {
						rel: "modulepreload",
			...
			if (!resource) {
				...
				if (resource = ownerDocument.querySelector(getStylesheetSelectorFromKey(key))) state.loading = 5;
					...
					link$2._p = new Promise(function(resolve, reject) {
						link$2.onload = resolve;
						link$2.onerror = reject;
					});
...
function RootComponent() {
	...
	if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
		t0 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {});
		$[0] = t0;
	} else t0 = $[0];
	let t1;
	...
	if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
		t2 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
			t0,
			t1,
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
				className: "left-0 z-20 w-full pb-2 text-center text-sm decoration-2 brightness-50",
...
var $$splitComponentImporter$1 = () => __vitePreload(() => import("./routes-CxqBet-k.js"), __vite__mapDeps([0,1,2,3,4,5]));
const Route$1 = createFileRoute("/")({
	component: lazyRouteComponent($$splitComponentImporter$1, "component"),
	head: () => ({ meta: [{ title: "Divij Verma | Portfolio" }] })
});
var $$splitComponentImporter = () => __vitePreload(() => import("./work-oj_KHZA9.js"), __vite__mapDeps([6,1,2,3,4,7,8,9,10]));
const Route$2 = createFileRoute("/work/")({
	component: lazyRouteComponent($$splitComponentImporter, "component"),
	head: () => ({ meta: [{ title: "Divij Verma | Work" }] })
});
...
function DefaultErrorComponent(props) {
	...
	let t0;
	if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
		t0 = /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Something went wrong" });
		$[0] = t0;
	} else t0 = $[0];
	let t1;
	if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
		t1 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
			to: "/",
			children: ["Go back to", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "cursor-pointer underline decoration-1 hover:decoration-2 active:decoration-2",
				children: "Home"
			})]
		});
		$[1] = t1;
	...
	const t3 = isVisible ? props.error.message : "show error message";
	let t4;
	if ($[3] !== t3) {
		t4 = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "absolute inset-0 z-30 flex size-full flex-col items-center justify-center bg-theme-primary text-center",
			children: [
				t0,
				t1,
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
